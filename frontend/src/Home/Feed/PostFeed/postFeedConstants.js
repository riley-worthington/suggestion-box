...
export const LOAD_USER_POST_VOTES_REQUEST = 'LOAD_USER_POST_VOTES_REQUEST';
export const LOAD_USER_POST_VOTES_SUCCESS = 'LOAD_USER_POST_VOTES_SUCCESS';
export const LOAD_USER_POST_VOTES_FAILURE = 'LOAD_USER_POST_VOTES_FAILURE';
